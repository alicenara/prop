 ...
 */
public class VistaGestioModificarArea extends javax.swing.JPanel {

    /**
     * Creates new form VistaGestióAfegirEstanteria
     */
    public VistaGestioModificarArea() {
        initComponents();
    }
    ...
    private void botoAfegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoAfegirActionPerformed
        ...
        if(nom == null || nom.equals("")) {
            JOptionPane.showMessageDialog(null, "No hi pot haver un àrea sense nom","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            CtrlInterficie.modificarNomArea((String) comboArea.getModel().getSelectedItem(), nom);
        }
        catch(Exception exc) {
